...
function ContactSection() {
  ...
  return (
    <section className="bg-red-50 py-30 px-4 scroll-mt-20" id="contact">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center mb-12 max-w-2xl mx-auto text-lg">
          ...
          out the form or reach out directly via telegram or email.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-red-500 text-white font-semibold px-6 py-3 rounded-md cursor-pointer"
              disabled={loading}
            >
          ...
          <div className="flex flex-col justify-center text-center md:text-left space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                12/A, Madison Street, New York, NY, USA
              </p>
            </div>
            <div>
